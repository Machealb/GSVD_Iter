...
%
% This is a very primilar version for partial GSVD computation based on the manuscript paper:
% Haibo Li,"The joint bidiagonalization of a matrix pair with inaccurate inner iterations" 
%
% More efforts will be need to add functions and fix bugs to make the jbdgsvd to 
% be an available and efficient code for partial GSVD of a large scale {A,B}.
%
% Haibo Li, Institute of Computing Technology, Chinese Academy of Sciences, Dec 13, 2022.
